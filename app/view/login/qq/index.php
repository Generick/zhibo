...
$qq_oauth_config = array(
    ...
    'oauth_callback'=>("http://".$_SERVER['HTTP_HOST']."/app/view/login/qq/reg"),//回调地址
...
switch($action){
	...
	case 'regmobile':
	case 'reg':
		include_once("common/function/header.inc.php");
		include_once('common/function/login.func.php');
		include_once('common/function/path_config.php');
		qq_callback();
