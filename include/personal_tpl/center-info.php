        ...
        <div class="c-funds">
            ...
            if($user['roomNumber']){
                ...
                <style>
                    ...
                    .dui-control{padding-bottom: 20px;}
                    .dui-control button{width:142px;height: 42px;border-radius: 3px;border:none;margin-left: 50px;}
                    .dui-queren{background-color: #FFBE4A; color: #fff2ed;}
                    .dui-cancel{color: #333;}
                </style>
            <?php }?>
        </div>
    </div>
