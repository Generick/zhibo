...
>>>>>>> af93197f9196da7e299d14f30d25d08935181674
			...
			Tools.getJson({
				...
				if (datas != null && datas.length > 0) {
					$.each(datas, function(k, v) {
						$active = k==0?"active":"";
                        if(v.url !=''){
                            item+='<div class="item '+$active+'"><a  target="_blank" href="'+v.url+'"><img class="lazy" data-src="holder.js/1128x320/auto/#777:#777" alt="900x500" src="'+v.image+'" data-holder-rendered="true"/></a></div>';
						}else{
                            item+='<div class="item '+$active+'"><a  target="_blank" href="javascript:;"><img class="lazy" data-src="holder.js/1128x320/auto/#777:#777" alt="900x500" src="'+v.image+'" data-holder-rendered="true"/></a></div>';
						}
						if(k==0){
