...
$(document).ready(function(){
				...
				if (data != null) {
					...
					$.each($listObj, function() {
						...
						if (_self.online == true) {
							htm += Tools.stringFormat(Mycare.lii,_self.roomNumber,_self.imagePrivate, ndecodeURI(_self.nickName), ndecodeURI(_self.nickName), "<p class='yesLiv'><span>"+Math.ceil(_self.onlineTime/600000)+"</span>����ǰ����</p>",_self.totalpoint);
						}else{
							htm += Tools.stringFormat(Mycare.lii,_self.roomNumber,_self.imagePrivate, ndecodeURI(_self.nickName), ndecodeURI(_self.nickName),'<p class="ynLiv">δ����</p>',_self.totalpoint);
						}
					})
	...
	$(function(){
		...
		var ulList={
			"dayList":"/files/giftWeels.json", //�����܉Y
			...
			"hy_week":"/files/fansActive.json",//��Ծ��
	
			"hy_month":"/files/fansActive.json",//��Ծ��
	
			"hy_year":"/files/fansActive.json",//��Ծ��
			...
			"anc_game":"/files/gameAnchors.json",//�����Ƽ�
		...
		var compiliter={
			bightml:
				...
				{3}\
					<div class="firT thumbnail clearfix">\
						...
						<p class="text-center">����<span>{5}</span></p>\
						 </div>\
				...
				'<div class="{0}">\
                        ...
                        {5}\
							<div class="hotT thumbnail">\
								<p class="text-center">����<span>{6}</span></p>\
							</div>\
							<div class="hotB">\
			...
			sonh:
				...
				<div class="hotT thumbnail">\
				<div class=""></div>\
				<p class="text-center">����<span>268</span></p>\
				</div>\
					<div class="hotB">\
						<span class="colorPin f14">С����sasa</span>\
						<p class="f12">\
							<span>30</span>\
							<span>����֮ǰ</span>\
						</p>\
