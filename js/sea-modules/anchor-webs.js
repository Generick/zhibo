    ...
    Webs.prototype = {
        ...
        agents : function(){
            ...
            if(navigator.userAgent.indexOf("MSIE")>0){
                if(navigator.userAgent.indexOf("MSIE 6.0")>0){$ie = true;}
                if(navigator.userAgent.indexOf("MSIE 7.0")>0){$ie = true;}
                if(navigator.userAgent.indexOf("MSIE 8.0")>0){$ie = true;}
                if(navigator.userAgent.indexOf("MSIE 9.0")>0){$ie = true;}
            }
            return $ie;
        },
