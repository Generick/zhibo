...
<head lang="en">
    ...
    <link href="<?php echo $page_var['cdn_domain']?>/skin/desert/css/live.css?v=<?php echo $vsn;?>" rel="stylesheet">
    ...
    <script type="text/javascript" class="1sss">
        var UIF = {
        ...
        $(function() {
            ...
            $(".director .dm1").click(function(){
                $(this).hide();
                $(".director .dm2").show();
            })
            $(".director .dm2").click(function(){
                $(this).hide();
                $(".director .dm3").show();
            })
            $(".director .dm3").click(function(){
               $('.director').remove();
            })
...
<div class="director" <?php if(!isset($_GET[first])){echo "style='display: none'";}?>>
    <div class="dm dm1" style="background: url('/img/pic_page_01.png') no-repeat;"></div>
    <div class="dm dm2" style="background: url('/img/pic_page_02.png') no-repeat;"></div>
    <div class="dm dm3" style="background: url('/img/pic_page_03.png') no-repeat;"></div>
</div>
<div class="nav-left">
...
<div class="guard-area myDiv6">
    <div class="guard-header">
        ...
        <span class="kais button button-highlight button-rounded">开通守护</span>
    </div>
...
<div class="chat-area myDiv4">
    <div class="chat-header">
        ...
        <div class="issel chat_right" ct="ch1">聊天</div>
        <div class="chat_right" id="choSong" ct="ch2">贵宾</div>
    </div>
    <div class="chs1">
    ...
    <div class="mainGifts" >
        <div class="giftHeader">
            ...
            foreach($giftcate as $giftcateid=>$arr):
                ...
                ?>
                <span id="gt<?php echo $giftcateid;?>"  rel="<?php echo $giftcateid;?>"  <?php echo $ac;?> class="ct"><?php echo $arr["catename"];?></span>
            <?php endforeach;?>
        </div>
        <div class="giftContents">
            ...
            <div class="sendInfos">
                ...
                <div class="sendBtn"><a href="javascript:;" id="sendGiftBtn" class="button button-highlight button-rounded sendGiftBtn">赠送</a></div>
            </div>
        </div>
    </div>
</div>
