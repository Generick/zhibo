...
$showinfo=$db->CacheGetRow(10,"select u.userId as userId,u.nickname as nickname,u.city as city,a.roomNumber as roomNumber,o.online as online from bu_user u left join  bu_user_anchors a on u.userId = a.userId LEFT JOIN bu_user_online o on u.userId = o.userId WHERE a.roomNumber=$roomnumber");
